...
const options = [
  {
    label: 'Public Videos',
    subtitle: 'Free videos available to everyone',
    color: '#F04F4F',
    bg: '#FFF0F0',
    icon: (
      <Svg width={28} height={28} viewBox="0 0 24 24" fill="none">
        <Path d="M15 10l4.553-2.277A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M3 8a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z" stroke="#F04F4F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </Svg>
    ),
    type: 'public',
  },
  {
    ...
    subtitle: 'Exclusive videos for enrolled students',
    color: '#7B5ACF',
    bg: '#F3EEFF',
    icon: (
      <Svg width={28} height={28} viewBox="0 0 24 24" fill="none">
        <Path d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" stroke="#7B5ACF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </Svg>
    ),
    type: 'private',
  },
